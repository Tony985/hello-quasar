  ...
  <q-page padding>
    <div class="form q-mb-lg">
      <div class="row q-mb-md">
        ...
        <label class="error" v-show="type === 'nomE'">Maximum 15 caractères
        </label>
      </div>
      <div class="row q-mb-md">
        <label>Age:</label>
        <input v-model="age" type="number">
        <label class="error" v-show="type === 'ageE'">Veuillez entrer un âge compris entre 1 et 100</label>
      </div>
      <div class="row">
    ...
    <div class="description q-mb-lg">
      ...
      <p>Dans 10 ans, j'aurai <b>{{ age }}</b> ans.</p>
